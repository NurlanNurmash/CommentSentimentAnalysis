...
### Data
The dataset was taken From Kaggle "Sentiment Analysis Dataset", here the link ("https://www.kaggle.com/datasets/abhi8923shriv/sentiment-analysis-dataset?select=training.1600000.processed.noemoticon.csv") 
